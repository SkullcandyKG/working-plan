<style>
  /* Полный сброс стилей для развертывания на весь экран */
  body, .markdown-body {
  ...
  /* Принудительно окрашиваем контейнеры GitHub, которые могли давать белый фон */
...
<p style="color: #94a3b8; margin-bottom: 25px;"><i>Приоритетные направления с жестким контролем сроков и этапов реализации.</i></p>

<!-- Блок карточек без использования таблиц (чистый CSS Flex) -->
<div style="display: flex; flex-wrap: wrap; gap: 20px; margin-bottom: 20px; font-family: -apple-system, sans-serif;">

  <!-- Карточка 1 -->
  <div style="flex: 1 1 calc(50% - 10px); min-width: 300px; background: #111827; border: 1px solid #1e293b; border-radius: 20px; padding: 25px; border-left: 6px solid #fbbf24; box-shadow: 0 4px 20px rgba(0,0,0,0.15); box-sizing: border-box;">
  ...
  <!-- Карточка 2 -->
  <div style="flex: 1 1 calc(50% - 10px); min-width: 300px; background: #111827; border: 1px solid #1e293b; border-radius: 20px; padding: 25px; border-left: 6px solid #10b981; box-shadow: 0 4px 20px rgba(0,0,0,0.15); box-sizing: border-box;">
    <div style="display: flex; justify-content: space-between; font-size: 12px; font-weight: bold; margin-bottom: 12px; align-items: center;">
  ...
  <!-- Карточка 3 -->
  <div style="flex: 1 1 calc(50% - 10px); min-width: 300px; background: #111827; border: 1px solid #1e293b; border-radius: 20px; padding: 25px; border-left: 6px solid #3b82f6; box-shadow: 0 4px 20px rgba(0,0,0,0.15); box-sizing: border-box;">
    <div style="display: flex; justify-content: space-between; font-size: 12px; font-weight: bold; margin-bottom: 12px; align-items: center;">
  ...
  <!-- Карточка 4 -->
  <div style="flex: 1 1 calc(50% - 10px); min-width: 300px; background: #111827; border: 1px solid #1e293b; border-radius: 20px; padding: 25px; border-left: 6px solid #f59e0b; box-shadow: 0 4px 20px rgba(0,0,0,0.15); box-sizing: border-box;">
    <div style="display: flex; justify-content: space-between; font-size: 12px; font-weight: bold; margin-bottom: 12px; align-items: center;">
...
<!-- Одиночная широкая карточка 5 -->
<div style="margin-bottom: 40px; font-family: -apple-system, sans-serif;">
